        ...
        (match s with
         ...
         | A.Gram.NT nt ->
           (match A.goto_table s1 nt with
            ...
            | None ->
              forallb_items items_map0 (fun s1' prod' pos' _ ->
                implb
  ...
  let is_complete _ =
    ...
    (&&)
      ((&&)
        ...
        (is_non_terminal_goto items_map0)) (is_non_terminal_closed items_map0)
 end
